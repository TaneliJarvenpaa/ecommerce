...
function NavItems({isModelView=false}) {
  return (
    <div
      ...
      id="nav-items"
    >
      <ul className={`flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg md:flex-row md:space-x-8 md:mt-0 md:border-0 bg-white  ${isModelView ? "border-none": "border border-gray-100"}`}>
        {isAdminView
...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <CommonModel showModelTitle={false}
